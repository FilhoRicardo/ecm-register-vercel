...
CREATE TABLE IF NOT EXISTS properties (
  ...
  heating_carrier TEXT NOT NULL DEFAULT 'district_heating',
  cooling_carrier TEXT NOT NULL DEFAULT 'district_cooling',
...
const MIGRATIONS = [
  ...
  "ALTER TABLE properties ADD COLUMN heating_carrier TEXT NOT NULL DEFAULT 'district_heating'",
  "ALTER TABLE properties ADD COLUMN cooling_carrier TEXT NOT NULL DEFAULT 'district_cooling'",
  ...
  "UPDATE properties SET heating_carrier = 'district_heating' WHERE heating_carrier = '' OR heating_carrier IS NULL",
  "UPDATE properties SET cooling_carrier = 'district_cooling' WHERE cooling_carrier = '' OR cooling_carrier IS NULL",
